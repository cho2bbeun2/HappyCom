            ...
            <div>
              ...
              <div class="dropdown" style="margin: 10px">
                ...
                >
                  ...
                  <tbody>
                    <tr v-for="sensorData in sensorDataLogList" in :key="sensorData.dataId">
                      <td>
                        {{ sensorData.createdAt.split("T")[0].substring() }}
                        <!-- substring(5) -->
                      </td>
                      <td>
                        {{ sensorData.createdAt.split("T")[1].substring(0, 8) }}
                        <!-- substring(0, 5) -->
                      </td>
    ...
    async getPosSensorDataLog(posId = 1) {
      try {
        ...
        for(var list of templist){
          this.posSensorDataLogList.push(list);
        }
